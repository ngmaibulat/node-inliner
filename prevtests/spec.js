    ...
    describe("links", function () {
        ...
        it("should inline remote links with no protocol", function (done) {
            var expected = readFile(
                "test/cases/css-remote-no-protocol_out.html"
            );

            inline.html(
                {
                    fileContent: readFile(
                        "test/cases/css-remote-no-protocol.html"
                    ),
                    relativeTo: "test/cases/",
                },
                function (err, result) {
        ...
        it("should inline remote links relative to a url", function (done) {
            var expected = readFile(
                "test/cases/css-remote-relative-to-url_out.html"
            );

            inline.html(
                {
                    fileContent: readFile(
                        "test/cases/css-remote-relative-to-url.html"
                    ),
        ...
        it("should apply the requestResource option", function (done) {
            ...
            inline.html(
                ...
                function () {
                    ...
                    assert.equal(
                        uris[1],
                        "http://example.com/assets/icon.png?a=1"
                    );
                    done();
                }
            );
